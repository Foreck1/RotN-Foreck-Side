...
mods.betterwithmods.Anvil.addShaped(<malisisdoors:garage_door>, [
   [<ore:latchRedstone>, <ore:latchRedstone>, <ore:latchRedstone>, <ore:latchRedstone>],
   [<rustic:iron_lattice>, <rustic:iron_lattice>, <rustic:iron_lattice>, <rustic:iron_lattice>],
   [<rustic:iron_lattice>, <rustic:iron_lattice>, <rustic:iron_lattice>, <rustic:iron_lattice>],
